...
export default class Cart extends Component {
    ...
    render() {
        ...
        return (
        <div className="col-md-12 col-lg-12 col-sm-12 mt-4 col-xs-12">
            <MobileConsumer>
                {
                    (value) => {
                        if(value){
                                        ...
                                        { value.cart.length > 0 ? (
                                            <div className="container text-center">
                                                <div className="row mx-auto Cart-title-header">
                                                    <div className="col-md-2 col-sm-2 col-xs-2 offset-sm-1 offset-md-1 offset-lg-1 col-lg-2">
                                                        <strong>Name </strong>
                                                    </div>
                                                    ...
                                                    value.cart.map(data => {
                                                        return(
                                                            <div className="row mx-auto card-show py-2">
                                                                ...
                                                                <div className="col-md-2 col-sm-2 col-xs-2 col-lg-2 cart-price-style">
